...
from src.store.store_errors import *

from src.store.datafile_adapters import AbstractDataFileAdapter, XarrayDataArrayNetCDFAdapter
...
class FileSystemDAO(AbstractDataAccessObject):
    ...
    def _deserialize(self, data_object):
        ...
        data_object.attrs = attrs
        print(f"DESERIALIZED: {attrs}", flush=True)
        return data_object
