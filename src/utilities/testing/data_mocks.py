...
from src.utilities.testing.helper_mocks import *
...
acquisition_notes_term = {
    ...
    "description": "Notes on the progeny of an acquisition. This field is usually automatically populated with an explanation of what the acquisition is by an import adapter within src."
}
dimensions_term = {
